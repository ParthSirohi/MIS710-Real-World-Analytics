...
fit.OWA <- function(the.data,output.1="output2.txt",stats.1="stats2.txt") {
  # preliminary information										
  ycol <- ncol(the.data)
  n <- ycol-1
  instances <- nrow(the.data)
...
fit.choquet <- function(the.data,output.1="output3.txt",stats.1="stats3.txt",kadd=(ncol(the.data)-1)) {
  # preliminary information
  ycol <- ncol(the.data)
  n <- ycol - 1
  instances <- nrow(the.data)
